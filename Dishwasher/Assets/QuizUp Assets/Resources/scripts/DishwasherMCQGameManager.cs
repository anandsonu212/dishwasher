...
public class DishwasherMCQGameManager : MonoBehaviour
{
    ...
    void SetCurrentQuestion(int questionIndex)
    {
        ...
        //}
        Debug.Log("Argument===>" + questionIndex);
    ...
    void stopgame()
    {
        ...
        Debug.Log("I just scored " + correctanswers + " in QuizUp Android Game. CAN YOU BEAT ME?");
        sethighscores();
